...
'''
    return prompt + system_prompt_summarize()
...
You need to make sure you always have more than 10 twigs and 10 cutgrass. 千万注意，只有Collectable为True的草和树枝才可以PICK，同理只有显示Choppable为True的树才可以CHOP。
